<template>
  ...
  >
    ...
    <button
      type="button"
      class="m_importMedias--button button button-round margin-bottom-small padding-none bg-noir c-blanc button_addMedia m_addMedias--buttons--openHideButton"
      :class="{
