  ...
  <div class="packery-item" :style="itemSize">
    ...
    >
      ...
      <div class="packery-item-content--meta">
        ...
        <span class="packery-item-content--meta--comments" v-if="can_edit">
          <!-- {{ media.ordre }} -->
          <input type="number" v-model="media_ordre" />
          <!-- <button type="button" @click="updateOrdre">✓</button> -->
          <button type="button" @click="moveRight">↑</button>
          <button type="button" @click="moveLeft">↓</button>
        </span>
      </div>
