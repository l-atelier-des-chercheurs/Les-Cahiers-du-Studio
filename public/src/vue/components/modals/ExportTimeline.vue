<template>
  ...
  >
    ...
    <template slot="sidebar">
      ...
      <div class="margin-bottom-small">
        <span class="switch">
          <input type="checkbox" class="switch" id="downloadswitch" v-model="export_options.allow_download">
      ...
      <div class="margin-bottom-small">
        <span class="switch">
          <input type="checkbox" class="switch" id="publiconlyswitch" v-model="export_options.only_public">
  ...
  methods: {
    downloadExport() {
      ...
      if(!!this.export_options.password_protect) {
        this.export_options.password_protect = hashCode(this.export_options.password_protect);
      }
