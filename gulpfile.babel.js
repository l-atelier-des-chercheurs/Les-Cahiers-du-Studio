...
var userScripts = ['client/js/main.js'];
var vueMain = ['client/js/app.js'];
...
gulp.task('lint', function() {
  return gulp
    .src(nodeScripts.concat(userScripts, vueMain))
    .pipe(
      jshint({
        esversion: 6
      })
...
gulp.task('watch', function() {
  gulp.watch(
    [userScripts, vueMain, watchedScriptsAndComponents, nodeScripts],
    ['lint', 'vue', 'scripts']
  );
